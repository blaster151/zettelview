...
const App: React.FC = () => {
  ...
  const {
    ...
    selectedNoteId,
    setViewMode,
    openAISummaryPanel: showAI,
    closeAISummaryPanel: hideAI,
    openExportImport: showExport,
    closeExportImport: hideExport,
    openOnboarding: showOnboardingUI,
    closeOnboarding: hideOnboardingUI,
    openHelp: showHelpUI,
    closeHelp: hideHelpUI,
    openStats: showStatsUI,
    closeStats: hideStatsUI,
    openTemplateSelector: showTemplateSelectorUI,
    closeTemplateSelector: hideTemplateSelectorUI,
    openSaveAsTemplate: showSaveAsTemplateUI,
    closeSaveAsTemplate: hideSaveAsTemplateUI,
    openCollaborationPanel: showCollaborationPanelUI,
    closeCollaborationPanel: hideCollaborationPanelUI,
    openPluginManager: showPluginManagerUI,
    closePluginManager: hidePluginManagerUI,
    openPluginStore: showPluginStoreUI,
    closePluginStore: hidePluginStoreUI,
    setSelectedNoteId
  } = useUIStore();
